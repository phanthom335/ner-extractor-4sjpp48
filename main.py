    """
    Ner Extractor 4sjpp48
    =====================
    Open-source NLP tool built to interpret text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Ner Extractor 4sjpp48"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to interpret text data with state-of-the-art techniques.")
